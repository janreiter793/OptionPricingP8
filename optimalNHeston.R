...
# of 29-04-2024.
files <- c("/srv/scratch/jrsa20/P9-Projekt/data/AMZN_options.csv",
           "/srv/scratch/jrsa20/P9-Projekt/data/BRK-B_options.csv",
           "/srv/scratch/jrsa20/P9-Projekt/data/GOOG_options.csv",
           "/srv/scratch/jrsa20/P9-Projekt/data/GOOGL_options.csv",
           "/srv/scratch/jrsa20/P9-Projekt/data/TSLA_options.csv")
alpha = 1.5
